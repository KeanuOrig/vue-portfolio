        ...
        <ul class="-mb-8">
          ...
          <li v-for="(experience, index) in experiences" :key="experience.id">
            <div class='relative pb-8'>
              <span :class="['absolute top-5 left-5 -ml-px h-full w-0.5 bg-gray-200', isVisible ? `animate-fadeinbounceup animation-delay-${index * 1000}` : '']"></span>
              <div class="relative flex items-start space-x-3">
                <div>
                  <div :class="['relative px-1 opacity-0', isVisible ? `animate-fadeinbounceup animation-delay-${index * 1000}` : '']">
                ...
                <div class='min-w-0 flex-1 py-0'>
                  <div :class="['text-md text-gray-500 ', isVisible ? `animate-fadeinbounceup` : '']" 
                    >
                    <div>
                  ...
                  <div :class="['mt-2 text-gray-700 opacity-0', isVisible ? `animate-fadeinbounceup` : '']" 
